...
public class ScannerTest {
    ...
    public void shouldProduceKeywords() {
        List<Token> expecteds = List.of(
                ...
                new Token(FALSE, "false", Optional.of(LoxValue.Intern.FALSE), 1),
                new Token(FUN, "fun", Optional.empty(), 1),
                new Token(FOR, "for", Optional.empty(), 1),
                new Token(IF, "if", Optional.empty(), 1),
                new Token(NIL, "nil", Optional.of(LoxValue.Intern.NIL), 1),
                ...
                new Token(TRUE, "true", Optional.of(LoxValue.Intern.TRUE), 1),
